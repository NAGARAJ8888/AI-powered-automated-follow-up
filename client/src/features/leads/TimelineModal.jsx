      ...
      <div className="relative min-h-full flex items-center justify-center p-4">
        ...
        >
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-slate-800 rounded-2xl shadow-lg overflow-hidden">
            {/* Use flex column so body can scroll while header stays visible */}
            <div className="flex flex-col max-h-[calc(100vh-2rem)]">
              <div className="p-4 sm:p-5 border-b border-gray-100 dark:border-slate-800 flex items-start justify-between gap-4 shrink-0">
                <div>
